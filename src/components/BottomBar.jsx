...
export function BottomBar({ selected }) {
	return (
		<nav className={styles['bottom-bar'] + ' bottom-bar' + ' navigation'}>
			<Link
				to={'/'}
			...
			<Link
				to={'/rooms'}
				className={selected === 'room' ? styles['selected'] : null}
			>
				<div className={styles['room']}></div>
			</Link>
			<Link
				to={'/sounds'}
				className={selected === 'music' ? styles['selected'] : null}
			>
			...
			<Link
				to={'/meditations'}
				className={
					selected === 'meditation' ? styles['selected'] : null
				}
			>
